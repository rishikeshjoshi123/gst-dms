...
BEGIN
  ...
  INSERT INTO public.outbox_events(org_id,aggregate_type,aggregate_id,event_kind,payload,idempotency_key) VALUES(org_a,'document',doc_a,'document.processing_requested.v1','{"document_id":"safe"}','outbox-a');
