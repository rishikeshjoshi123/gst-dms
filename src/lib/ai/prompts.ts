...

{
  ...
  "financial_years": ["array of individual FYs in YYYY-YY format. ALWAYS expand ranges into individual elements. Example: a period covering April 2018 to March 2021 must be [\"2018-19\", \"2019-20\", \"2020-21\"]. Never use range strings like \"2018-19 to 2020-21\"."],
  ...
  "chaining_attributes": {
    "references_documents": ["array of reference numbers, ARNs, or DINs of PARENT documents this responds to"],
