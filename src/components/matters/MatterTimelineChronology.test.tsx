...
const relationshipListSource = readFileSync(new URL('./MatterRelationshipAuthoring.tsx', import.meta.url), 'utf8')
...
test('live Timeline is bounded chronology, not the legacy graph or links', () => {
  ...
  assert.match(inspectorSource, /MatterEffectiveRelationshipList/)
  assert.match(relationshipListSource, /No active Timeline relationships involve this proceeding/)
  assert.match(relationshipListSource, /Timeline progression/)
  assert.match(relationshipListSource, /describeMatterTimelineRelationship/)
...
test('Graph is an isolated desktop-only read presentation with chronology fallback', () => {
  ...
  assert.match(adaptiveSource, /if \(!desktopCapable \|\| !graph\)/)
  assert.match(adaptiveSource, /loaded\?\.requestKey === props.graphRequestKey/)
  assert.match(adaptiveSource, /loaded\?\.contextKey === props.graphContextKey/)
