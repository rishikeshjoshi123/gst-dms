...
function renderSpecimen(specimenId) {
  const specimens = {
    ...
    'task-comments-layout': `<figure class="visual-reference"><figcaption><span class="visual-reference-label">Approved layout</span><strong>Task comments</strong><span>A peer Comments tab keeps the task identity fixed while an independent, chronological conversation scrolls.</span></figcaption><div class="workspace-specimen"><div class="workspace-specimen-header"><span><b>Verify residual invoice set</b><small>Apex Auto Components · In progress</small></span><span class="specimen-badge specimen-badge-warning">In progress</span></div><div class="workspace-tabs"><span>Task details</span><b>Comments</b></div><div class="workspace-timeline"><span><i></i>Meera added task-scoped context <small>10:28</small></span><span><i></i>One-message reply with an accessible mention <small>11:04</small></span></div><div class="specimen-actions"><span class="specimen-button specimen-button-secondary">Mention</span><span class="specimen-button specimen-button-primary">Send</span></div></div></figure>`,
    'review-workspace-layout': `<figure class="visual-reference"><figcaption><span class="visual-reference-label">Approved layout</span><strong>Review workspace</strong><span>A compact filterable queue opens one stable Evidence/Decision inspector; citations replace the queue with the shared PDF workspace.</span></figcaption><div class="workspace-specimen"><div class="workspace-specimen-header"><span><b>Review</b><small>Search · Type · Priority · Status</small></span><span class="specimen-badge specimen-badge-warning">Needs review</span></div><div class="workspace-tabs"><b>Evidence</b><span>Decision</span></div><div class="workspace-specimen-body"><span>56px queue rows → selected inspector → exact citation</span><span class="specimen-badge">Two-state lifecycle</span></div></div></figure>`,
    'document-hub-layout': `<figure class="visual-reference"><figcaption><span class="visual-reference-label">Approved layout</span><strong>Document Hub and Workbench</strong><span>A stable queue opens an evidence-first inspector; source viewing replaces the queue without moving the inspector.</span></figcaption><div class="workspace-specimen"><div class="workspace-specimen-header"><span><b>Document Hub</b><small>My uploads · Search · Status</small></span><span class="specimen-button specimen-button-primary">Upload PDFs</span></div><div class="workspace-tabs"><b>Queue</b><span>Overview</span><span>Extracted data</span></div><div class="workspace-specimen-body"><span>Full queue → 60/40 details → cited PDF</span><span class="specimen-badge">Mobile verified</span></div></div></figure>`,
  };
